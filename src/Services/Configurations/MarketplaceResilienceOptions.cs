...
public class MarketplaceResilienceOptions
{
    ...
    /// Default: 20 (sized to take advantage of the Marketplace API quota of 400 req/min
    /// for high-volume publishers; lower this if you encounter 429s under load).
    /// </summary>
    public int MaxConcurrentPlanFetches { get; set; } = 20;
